...
void deletionAtAnyPosition(Node* &tail , Node* &head , int position){
...
int main(){
    ...
    deletionAtAnyPosition(tail , head , 2 );
    cout<<"New nodes"<<endl;
    print(head);

    
    deletionAtAnyPosition(tail , head , 5 );
    cout<<"New nodes"<<endl;
    print(head);

    deletionAtAnyPosition(tail , head , 1 );
    cout<<"New nodes"<<endl;
    print(head);
}